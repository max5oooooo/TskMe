                        ...
                        <table className="w-full table-fixed border-collapse border-spacing-1 mt-5 text-sm ">
                            ...
                            <tbody className=" bg-white ">
                                ...
                                <tr className="text-sm text-gray-700 " >
                                    <td className="border-2 border-slate-400">{task.date} Ciao</td>
                                    <td className="border-2 border-slate-400">{task.title} come</td>
                                    <td className="border-2 border-slate-400 "> bla</td>
